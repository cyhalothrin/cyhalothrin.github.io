...
/***/ function(module, exports, __webpack_require__) {
	...
	var _DartsApp = __webpack_require__(/*! ./containers/DartsApp */ 177);
	
	var _DartsApp2 = _interopRequireDefault(_DartsApp);
	
	var _reducers = __webpack_require__(/*! ./reducers/reducers */ 223);
	
	var _reducers2 = _interopRequireDefault(_reducers);
	
	var _global = __webpack_require__(/*! ../css/global.css */ 191);
	...
	(0, _reactDom.render)(_react2.default.createElement(
	  ...
	  { store: store },
	  _react2.default.createElement(_DartsApp2.default, null)
	), rootElement);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utilsMapValues = __webpack_require__(/*! ../utils/mapValues */ 163);
	
	var _utilsMapValues2 = _interopRequireDefault(_utilsMapValues);
	
	var _utilsPick = __webpack_require__(/*! ../utils/pick */ 164);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentsProvider = __webpack_require__(/*! ./components/Provider */ 169);
	
	exports.Provider = _interopRequire(_componentsProvider);
	
	var _componentsConnect = __webpack_require__(/*! ./components/connect */ 171);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utilsStoreShape = __webpack_require__(/*! ../utils/storeShape */ 170);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utilsShallowEqual = __webpack_require__(/*! ../utils/shallowEqual */ 172);
	
	var _utilsShallowEqual2 = _interopRequireDefault(_utilsShallowEqual);
	
	var _utilsIsPlainObject = __webpack_require__(/*! ../utils/isPlainObject */ 173);
	
	var _utilsIsPlainObject2 = _interopRequireDefault(_utilsIsPlainObject);
	
	var _utilsWrapActionCreators = __webpack_require__(/*! ../utils/wrapActionCreators */ 174);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _actions = __webpack_require__(/*! ../actions/actions */ 178);
	
	var _Dartboard = __webpack_require__(/*! ../components/Dartboard */ 179);
	
	var _Dartboard2 = _interopRequireDefault(_Dartboard);
	
	var _PointsBoard = __webpack_require__(/*! ../components/PointsBoard */ 187);
	
	var _PointsBoard2 = _interopRequireDefault(_PointsBoard);
	
	var _global = __webpack_require__(/*! ../../css/global.css */ 191);
	
	var _global2 = _interopRequireDefault(_global);
	
	var _ControlPanel = __webpack_require__(/*! ../components/ControlPanel */ 192);
	...
	var DartsApp = (function (_Component) {
	  _inherits(DartsApp, _Component);
	
	  function DartsApp() {
	    _classCallCheck(this, DartsApp);
	
	    return _possibleConstructorReturn(this, Object.getPrototypeOf(DartsApp).apply(this, arguments));
	  }
	
	  _createClass(DartsApp, [{
	    key: 'render',
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'div',
	          { className: (0, _classnames2.default)([_global2.default.col4Lg, _global2.default.offset2Lg, _global2.default.col6Md, _global2.default.offset1Md]) },
	          _react2.default.createElement(_Dartboard2.default, { onThrowDart: function onThrowDart(points) {
	              return dispatch((0, _actions.throwDart)(points));
	            } })
	        ),
	        _react2.default.createElement(
	          'div',
	          { className: (0, _classnames2.default)(_global2.default.col2Lg, _global2.default.col3Md) },
	          _react2.default.createElement(_PointsBoard2.default, { result: this.props.result, player: this.props.player })
	        ),
	        _react2.default.createElement(_ControlPanel2.default, { undo: function undo() {
	            return dispatch((0, _actions.undo)());
	          }, startNewGame: function startNewGame() {
	            return dispatch((0, _actions.startNewGame)());
	          } })
	      );
	    }
	  }]);
	...
	exports.default = (0, _reactRedux.connect)(select)(DartsApp);
...
/***/ function(module, exports) {
	...
	var TROW_DART = exports.TROW_DART = 'TROW_DART';
...
/* 179 */
/*!****************************************!*\
  !*** ./src/js/components/Dartboard.js ***!
  \****************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var _Sector = __webpack_require__(/*! ./Sector */ 180);
	
	var _Sector2 = _interopRequireDefault(_Sector);
	
	var _PolarCoords = __webpack_require__(/*! ./PolarCoords */ 181);
	
	var _PolarCoords2 = _interopRequireDefault(_PolarCoords);
	
	var _NullPoint = __webpack_require__(/*! ./NullPoint */ 185);
	
	var _NullPoint2 = _interopRequireDefault(_NullPoint);
	
	var _Sector3 = __webpack_require__(/*! ../../css/Sector.css */ 184);
	
	var _Sector4 = _interopRequireDefault(_Sector3);
	...
	var Dartboard = (function (_Component) {
	  _inherits(Dartboard, _Component);
	  ...
	  function Dartboard(props) {
	    ...
	    _this.polarCoords = new _PolarCoords2.default(350, 350);
	    return _this;
	  }
	  ...
	  _createClass(Dartboard, [{
	    ...
	    key: 'handleThrowDart',
	    value: function handleThrowDart(points) {
	    ...
	    value: function render() {
	      ...
	      var STEP = 18;
	      var angle = 9;
	      var sectors = [17, 2, 15, 10, 6, 13, 4, 18, 1, 20, 5, 12, 9, 14, 11, 8, 16, 7, 19, 3];
	      var radius = 350;
	      var centerCoords = {
	        cx: radius,
	        cy: radius
	      ...
	      return _react2.default.createElement(
	        'svg',
	        { xmlns: 'http://www.w3.org/2000/svg', version: '1.1', width: '700', height: '700' },
	        _react2.default.createElement(
	          'g',
	          null,
	          _react2.default.createElement('circle', _extends({}, centerCoords, { r: radius, className: _Sector4.default.board })),
	          _react2.default.createElement('circle', _extends({}, centerCoords, { r: 0.0857 * radius, className: _Sector4.default.xxOdd, onClick: this.handleThrowDart.bind(this, 25) })),
	          _react2.default.createElement('circle', _extends({}, centerCoords, { r: 0.0429 * radius, className: _Sector4.default.xxEven, onClick: this.handleThrowDart.bind(this, 50) })),
	          sectors.map(function (number, index) {
	            ...
	            var options = {
	              ...
	              r: radius,
	              angle: startAngle,
	              polarCoords: _this2.polarCoords,
	              onThrowDart: _this2.props.onThrowDart
	            };
	            return _react2.default.createElement(_Sector2.default, _extends({ key: number }, options));
	          }),
	          _react2.default.createElement(_NullPoint2.default, { onThrowDart: this.handleThrowDart.bind(this, 0) })
	        )
	      );
	    }
	  }]);
	...
	Dartboard.propTypes = {
	  onThrowDart: _react.PropTypes.func.isRequired
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _RingSector = __webpack_require__(/*! ./RingSector */ 182);
	
	var _RingSector2 = _interopRequireDefault(_RingSector);
	
	var _Point = __webpack_require__(/*! ./Point */ 183);
	
	var _Point2 = _interopRequireDefault(_Point);
	
	var _Sector = __webpack_require__(/*! ../../css/Sector.css */ 184);
	...
	var Sector = (function (_Component) {
	  ...
	  function Sector(props) {
	    ...
	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Sector).call(this, props));
	  ...
	  _createClass(Sector, [{
	    ...
	    value: function render() {
	      ...
	      var x1ClassName = undefined;
	      var xxClassName = undefined;
	
	      if (this.props.index % 2) {
	        x1ClassName = _Sector2.default.x1Odd;
	        xxClassName = _Sector2.default.xxOdd;
	      } else {
	        x1ClassName = _Sector2.default.x1Even;
	        xxClassName = _Sector2.default.xxEven;
	      }
	
	      return _react2.default.createElement(
	        'g',
	        { className: 'sector' },
	        _react2.default.createElement(_RingSector2.default, _extends({ r1: r2, r2: r5, className: x1ClassName }, options, { onClick: this.handleThrowDart.bind(this, this.props.number) })),
	        _react2.default.createElement(_RingSector2.default, _extends({ r1: r, r2: r2, className: xxClassName }, options, { onClick: this.handleThrowDart.bind(this, this.props.number * 2) })),
	        _react2.default.createElement(_RingSector2.default, _extends({ r1: r3, r2: r4, className: xxClassName }, options, { onClick: this.handleThrowDart.bind(this, this.props.number * 3) })),
	        _react2.default.createElement(_Point2.default, pointOptions)
	      );
	    }
	  }]);
	...
	Sector.propTypes = {
	  ...
	  polarCoords: _react.PropTypes.instanceOf(_PolarCoords2.default),
	  onThrowDart: _react.PropTypes.func.isRequired
	};
...
/* 181 */
/*!******************************************!*\
  !*** ./src/js/components/PolarCoords.js ***!
  \******************************************/
/***/ function(module, exports) {
	...
	var PolarCoords = (function () {
	  function PolarCoords(xOffset, yOffset) {
	    _classCallCheck(this, PolarCoords);
	
	    this.xOffset = xOffset;
	    this.yOffset = yOffset;
	  }
	
	  _createClass(PolarCoords, [{
	...
	exports.default = PolarCoords;

/***/ },
/* 182 */
/*!*****************************************!*\
  !*** ./src/js/components/RingSector.js ***!
  \*****************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var RingSector = (function (_Component) {
	  _inherits(RingSector, _Component);
	
	  function RingSector(props) {
	    _classCallCheck(this, RingSector);
	
	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(RingSector).call(this, props));
	
	    _this.polarCoords = props.polarCoords;
	    return _this;
	  }
	
	  _createClass(RingSector, [{
	    key: 'shouldComponentUpdate',
	    value: function shouldComponentUpdate() {
	      return false;
	    }
	    ...
	    key: 'path',
	    value: function path(r1, r2, angle1, angle2) {
	      var CLOCKWISE = 1;
	      var COUNTERCLOCK = 0;
	
	      var xy1 = this.xy(r1, angle1);
	      var arc1 = this.arc(r1, this.xy(r1, angle2), COUNTERCLOCK);
	      var xy2 = this.xy(r2, angle2);
	      var arc2 = this.arc(r2, this.xy(r2, angle1), CLOCKWISE);
	
	      return 'M' + xy1 + ' ' + arc1 + ' L' + xy2 + ' ' + arc2 + ' z';
	    }
	  }, {
	    key: 'xy',
	    value: function xy(r, angle) {
	      var x = this.polarCoords.xPx(r, angle);
	      var y = this.polarCoords.yPx(r, angle);
	
	      return x + ',' + y;
	    }
	  }, {
	    key: 'arc',
	    value: function arc(r, xy, sweep) {
	      return 'A' + r + ',' + r + ' 0 0,' + sweep + ' ' + xy;
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      var path = this.path(this.props.r1, this.props.r2, this.props.angle1, this.props.angle2);
	      var onClick = this.props.onClick;
	
	      return _react2.default.createElement('path', _extends({ d: path, className: this.props.className }, { onClick: onClick }));
	    }
	  }]);
	...
	RingSector.propTypes = {
	  ...
	  r1: _react.PropTypes.number.isRequired,
	  r2: _react.PropTypes.number.isRequired,
	  angle1: _react.PropTypes.number.isRequired,
	  angle2: _react.PropTypes.number.isRequired,
	  polarCoords: _react.PropTypes.instanceOf(_PolarCoords2.default),
	  onClick: _react.PropTypes.func.isRequired
	};
	
	exports.default = RingSector;

/***/ },
/* 183 */
/*!************************************!*\
  !*** ./src/js/components/Point.js ***!
  \************************************/
/***/ function(module, exports, __webpack_require__) {
	  ...
	  _createClass(Point, [{
	    ...
	    value: function render() {
	      var options = {
	        ...
	        className: _Sector2.default.point
	      };
	      return _react2.default.createElement(
	        'text',
	        options,
...
/***/ function(module, exports) {
	...
	module.exports = {"x1Even":"Sector__x1Even____B19J","x1Odd":"Sector__x1Odd___3ZPjf","xxEven":"Sector__xxEven___1XPyN","xxOdd":"Sector__xxOdd___mlCcI","point":"Sector__point___IdDjH","board":"Sector__board___3cNqH"};

/***/ },
/* 185 */
/*!****************************************!*\
  !*** ./src/js/components/NullPoint.js ***!
  \****************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var _NullPoint = __webpack_require__(/*! ../../css/NullPoint.css */ 186);
	...
	var NullPoint = (function (_Component) {
	  _inherits(NullPoint, _Component);
	
	  function NullPoint() {
	    _classCallCheck(this, NullPoint);
	
	    return _possibleConstructorReturn(this, Object.getPrototypeOf(NullPoint).apply(this, arguments));
	  }
	
	  _createClass(NullPoint, [{
	    key: 'render',
	    value: function render() {
	      return _react2.default.createElement(
	        'text',
	        { x: '0', y: '78', className: _NullPoint2.default.label, onClick: this.props.onThrowDart },
	        '0'
	      );
	    }
	  }]);
	...
	exports.default = NullPoint;

/***/ },
/* 186 */
/*!*******************************!*\
  !*** ./src/css/NullPoint.css ***!
  \*******************************/
/***/ function(module, exports) {

	// removed by extract-text-webpack-plugin
	module.exports = {"label":"NullPoint__label___1iTJy"};

/***/ },
/* 187 */
/*!******************************************!*\
  !*** ./src/js/components/PointsBoard.js ***!
  \******************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var _constants = __webpack_require__(/*! ../constants/constants.js */ 188);
	
	var _PointsBoard = __webpack_require__(/*! ../../css/PointsBoard.css */ 189);
	...
	var PointsBoard = (function (_Component) {
	  _inherits(PointsBoard, _Component);
	
	  function PointsBoard() {
	    _classCallCheck(this, PointsBoard);
	
	    return _possibleConstructorReturn(this, Object.getPrototypeOf(PointsBoard).apply(this, arguments));
	  }
	
	  _createClass(PointsBoard, [{
	    key: 'renderColumn',
	    value: function renderColumn(col) {
	      return _react2.default.createElement(
	        'div',
	        { className: _PointsBoard2.default.column },
	        col.map(function (points, index) {
	          return _react2.default.createElement(
	            'div',
	            { className: _PointsBoard2.default.cell, key: index },
	            points
	          );
	        })
	      );
	    ...
	    key: 'renderPlayerLabel',
	    value: function renderPlayerLabel(title, name) {
	      var player = this.props.player;
	      var classes = [_PointsBoard2.default.column, _PointsBoard2.default.cell, _defineProperty({}, _PointsBoard2.default.activePlayer, player === name)];
	      return _react2.default.createElement(
	        'div',
	    ...
	    value: function renderHeader() {
	      return _react2.default.createElement(
	        'div',
	        { className: (0, _classnames2.default)(_PointsBoard2.default.row, _PointsBoard2.default.header) },
	        this.renderPlayerLabel('1-й игрок', _constants.PLAYER_1),
	        this.renderPlayerLabel('2-й игрок', _constants.PLAYER_2)
	      );
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      return _react2.default.createElement(
	        'div',
	        { className: _PointsBoard2.default.container },
	        this.renderHeader(),
	        _react2.default.createElement(
	          'div',
	          { className: _PointsBoard2.default.points },
	          _react2.default.createElement(
	            'div',
	            { className: _PointsBoard2.default.row },
	            this.renderColumn(this.props.result[_constants.PLAYER_1].points),
	            this.renderColumn(this.props.result[_constants.PLAYER_2].points)
	          )
	        ),
	        _react2.default.createElement(
	          'div',
	          { className: (0, _classnames2.default)(_PointsBoard2.default.row, _PointsBoard2.default.sum) },
	          _react2.default.createElement(
	            'div',
	            { className: (0, _classnames2.default)(_PointsBoard2.default.column, _PointsBoard2.default.cell) },
	            this.props.result[_constants.PLAYER_1].score
	          ),
	          _react2.default.createElement(
	            'div',
	            { className: (0, _classnames2.default)(_PointsBoard2.default.column, _PointsBoard2.default.cell) },
	            this.props.result[_constants.PLAYER_2].score
	          )
	        )
	      );
	    }
...
/***/ function(module, exports) {
	...
	var MAX_SCORE = exports.MAX_SCORE = 301;

/***/ },
/* 189 */
/*!*********************************!*\
  !*** ./src/css/PointsBoard.css ***!
  \*********************************/
/***/ function(module, exports) {

	// removed by extract-text-webpack-plugin
	module.exports = {"container":"PointsBoard__container___3lIwC","row":"PointsBoard__row___3jKJv","column":"PointsBoard__column___1TYNL","cell":"PointsBoard__cell___1UQ7A","header":"PointsBoard__header___oXxHF","sum":"PointsBoard__sum___2Dl3H","activePlayer":"PointsBoard__activePlayer___3HVbV","points":"PointsBoard__points___1BYgM"};
...
/***/ function(module, exports) {
	...
	// removed by extract-text-webpack-plugin
	module.exports = {"container":"global__container___2bhFY","offset1Md":"global__offset1Md___XEIu_","col6Md":"global__col6Md___2Elil","col3Md":"global__col3Md___3wOKm","offset2Lg":"global__offset2Lg___1hAOT","col4Lg":"global__col4Lg___2lxQ4","col2Lg":"global__col2Lg___2Wlvf"};

/***/ },
/* 192 */
/*!*******************************************!*\
  !*** ./src/js/components/ControlPanel.js ***!
  \*******************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var _eiUndo = __webpack_require__(/*! evil-icons/assets/icons/ei-undo.svg */ 193);
	
	var _eiUndo2 = _interopRequireDefault(_eiUndo);
	
	var _eiRefresh = __webpack_require__(/*! evil-icons/assets/icons/ei-refresh.svg */ 221);
	
	var _eiRefresh2 = _interopRequireDefault(_eiRefresh);
	
	var _ControlPanel = __webpack_require__(/*! ../../css/ControlPanel.css */ 222);
	...
	var ControlPanel = (function (_Component) {
	  ...
	  _createClass(ControlPanel, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        'div',
	        { className: _ControlPanel2.default.panel },
	        _react2.default.createElement(
	          'button',
	          { className: _ControlPanel2.default.button, type: 'button', onClick: this.props.startNewGame, title: 'Начать новую игру' },
	          _react2.default.createElement(_eiRefresh2.default, { className: _ControlPanel2.default.icon })
	        ),
	        _react2.default.createElement(
	          'button',
	          { className: _ControlPanel2.default.button, type: 'button', onClick: this.props.undo, title: 'Отменить ход' },
	          _react2.default.createElement(_eiUndo2.default, { className: _ControlPanel2.default.icon })
	        )
	      );
	    }
	  }]);
	...
	ControlPanel.propTypes = {
	  ...
	  startNewGame: _react.PropTypes.func.isRequired
	};
...
/* 193 */
/*!***********************************************!*\
  !*** ./~/evil-icons/assets/icons/ei-undo.svg ***!
  \***********************************************/
/***/ function(module, exports, __webpack_require__) {

	var React = __webpack_require__(/*! react */ 1);
	var helpers = __webpack_require__(/*! svg-react-loader/helpers */ 194)(__webpack_require__(/*! react-dom */ 158));
	...
	module.exports = React.createClass({
	    ...
	    getDefaultProps() {
	        return { "xmlns": "http://www.w3.org/2000/svg", "viewBox": "0 0 50 50" };
	    },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var forEach  = __webpack_require__(/*! lodash/collection/forEach */ 195);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var arrayEach = __webpack_require__(/*! ../internal/arrayEach */ 196),
	    baseEach = __webpack_require__(/*! ../internal/baseEach */ 197),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var baseForOwn = __webpack_require__(/*! ./baseForOwn */ 198),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var baseFor = __webpack_require__(/*! ./baseFor */ 199),
	    keys = __webpack_require__(/*! ../object/keys */ 203);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var createBaseFor = __webpack_require__(/*! ./createBaseFor */ 200);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var toObject = __webpack_require__(/*! ./toObject */ 201);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isObject = __webpack_require__(/*! ../lang/isObject */ 202);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getNative = __webpack_require__(/*! ../internal/getNative */ 204),
	    isArrayLike = __webpack_require__(/*! ../internal/isArrayLike */ 208),
	    isObject = __webpack_require__(/*! ../lang/isObject */ 202),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isNative = __webpack_require__(/*! ../lang/isNative */ 205);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isFunction = __webpack_require__(/*! ./isFunction */ 206),
	    isObjectLike = __webpack_require__(/*! ../internal/isObjectLike */ 207);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isObject = __webpack_require__(/*! ./isObject */ 202);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getLength = __webpack_require__(/*! ./getLength */ 209),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var baseProperty = __webpack_require__(/*! ./baseProperty */ 210);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isArguments = __webpack_require__(/*! ../lang/isArguments */ 213),
	    isArray = __webpack_require__(/*! ../lang/isArray */ 214),
	    isIndex = __webpack_require__(/*! ./isIndex */ 215),
	    isLength = __webpack_require__(/*! ./isLength */ 211),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isArrayLike = __webpack_require__(/*! ../internal/isArrayLike */ 208),
	    isObjectLike = __webpack_require__(/*! ../internal/isObjectLike */ 207);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getNative = __webpack_require__(/*! ../internal/getNative */ 204),
	    isLength = __webpack_require__(/*! ../internal/isLength */ 211),
	    isObjectLike = __webpack_require__(/*! ../internal/isObjectLike */ 207);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isArguments = __webpack_require__(/*! ../lang/isArguments */ 213),
	    isArray = __webpack_require__(/*! ../lang/isArray */ 214),
	    isIndex = __webpack_require__(/*! ../internal/isIndex */ 215),
	    isLength = __webpack_require__(/*! ../internal/isLength */ 211),
	    isObject = __webpack_require__(/*! ../lang/isObject */ 202);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getLength = __webpack_require__(/*! ./getLength */ 209),
	    isLength = __webpack_require__(/*! ./isLength */ 211),
	    toObject = __webpack_require__(/*! ./toObject */ 201);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var bindCallback = __webpack_require__(/*! ./bindCallback */ 219),
	    isArray = __webpack_require__(/*! ../lang/isArray */ 214);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var identity = __webpack_require__(/*! ../utility/identity */ 220);
...
/* 221 */
/*!**************************************************!*\
  !*** ./~/evil-icons/assets/icons/ei-refresh.svg ***!
  \**************************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = React.createClass({
	    ...
	    render() {
	        ...
	        return React.createElement(
	            'svg',
	            this.props,
	            React.createElement('path', { d: 'M25 38c-7.2 0-13-5.8-13-13 0-3.2 1.2-6.2 3.3-8.6l1.5 1.3C15 19.7 14 22.3 14 25c0 6.1 4.9 11 11 11 1.6 0 3.1-.3 4.6-1l.8 1.8c-1.7.8-3.5 1.2-5.4 1.2z' }),
	            React.createElement('path', { d: 'M34.7 33.7l-1.5-1.3c1.8-2 2.8-4.6 2.8-7.3 0-6.1-4.9-11-11-11-1.6 0-3.1.3-4.6 1l-.8-1.8c1.7-.8 3.5-1.2 5.4-1.2 7.2 0 13 5.8 13 13 0 3.1-1.2 6.2-3.3 8.6z' }),
	            React.createElement('path', { d: 'M18 24h-2v-6h-6v-2h8z' }),
	            React.createElement('path', { d: 'M40 34h-8v-8h2v6h6z' }),
	            React.Children.map(children, c => c)
	        );
	    }
	});
...
/* 222 */
/*!**********************************!*\
  !*** ./src/css/ControlPanel.css ***!
  \**********************************/
/***/ function(module, exports) {

	// removed by extract-text-webpack-plugin
	module.exports = {"button":"ControlPanel__button___1fyej","panel":"ControlPanel__panel___1Qm7F","icon":"ControlPanel__icon___WiRYd"};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var initialState = {
	  player: _constants.PLAYER_1,
	  result: (_result = {}, _defineProperty(_result, _constants.PLAYER_1, {
	    score: _constants.MAX_SCORE,
	    points: []
	  }), _defineProperty(_result, _constants.PLAYER_2, {
	    score: _constants.MAX_SCORE,
	    points: []
	  }), _result)
	};
	...
	function darts() {
	  ...
	  switch (action.type) {
	    case _actions.TROW_DART:
	      var player = state.player;
	      var _state$result$player = state.result[player];
	      var score = _state$result$player.score;
	      var points = _state$result$player.points;
	      ...
	      pushToHistory(state);
	      if (score < 0) {
	        player = player === _constants.PLAYER_1 ? _constants.PLAYER_2 : _constants.PLAYER_1;
	        return _extends({}, state, { player: player });
	      }
	      points = points.concat([action.points]);
	      var result = _extends((_extends2 = {}, _defineProperty(_extends2, _constants.PLAYER_1, state.result[_constants.PLAYER_1]), _defineProperty(_extends2, _constants.PLAYER_2, state.result[_constants.PLAYER_2]), _extends2), _defineProperty({}, player, { score: score, points: points }));
	      if (points.length % 3 === 0) {
	        player = player === _constants.PLAYER_1 ? _constants.PLAYER_2 : _constants.PLAYER_1;
	      }
	      return _extends({ player: player }, { result: result });
	    case _actions.UNDO:
	      return history.length ? history.pop() : state;
	    case _actions.START_NEW_GAME:
	      history.length = 0;
	      return initialState;
	    default:
	      return state;
